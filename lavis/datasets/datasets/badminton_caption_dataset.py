...
class BadmintonCaptionDataset(CaptionDataset):
    """Badminton caption dataset in instruction format"""
...
class BadmintonCaptionEvalDataset(CaptionEvalDataset):
    """BadmintonCaption eval dataset in instruction format"""
