...
from lavis.models.tc_clip_encoder.clip import clip
from lavis.models.tc_clip_encoder.clip.simple_tokenizer import SimpleTokenizer as _Tokenizer

from lavis.models.tc_clip_encoder.utils.print_utils import colorstr

# from lavis.models.tc_clip_encoder.trainers.vifi_clip import ViFiCLIP
# from lavis.models.tc_clip_encoder.trainers.tc_clip import TCCLIP
from lavis.models.tc_clip_encoder.trainers.tc_clip_feature_extracter import TCCLIP_encoder
...
def returnCLIP(config, logger=None, class_names=None, return_clip_model=False):
    ...
    if config.trainer_name == "TCCLIP_encoder":
        model = TCCLIP_encoder(config, clip_model, logger)
    else:
