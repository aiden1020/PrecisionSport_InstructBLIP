...
from lavis.models.tc_clip_encoder.clip.transformer_blocks_vifi import ResidualAttentionBlock
from lavis.models.tc_clip_encoder.clip.transformer_blocks_tc import TCAttentionBlock
